...
//create a variable to save initial data of the events array
var var_arr = ['Refresh the browser to see your events'];

//create your middleware to access the render(index.html)
...
app.post('/', (req, res) => {
    ...
    //paste in the index,js files here
    //create the token from the index.html here
